...
/* =========================================================
   EMERALDOS GOLD 1J — E.L.S.U.S. ROOT SHELL BRIDGE

   Add this script to the root E.L.S.U.S. gold-shell.html page.
   It does not publish or write system/emeraldGoldLatest.
========================================================= */
(function EmeraldGoldShell1JBridge(){
  if(window.__EMERALD_GOLD_SHELL_1J_BRIDGE__) return;
  window.__EMERALD_GOLD_SHELL_1J_BRIDGE__=true;

  const SHELL_VERSION="1.1";
  const SOURCE="emerald-gold-shell";
  const STATE_KEY="emeraldGoldShell_1j_bridge_state";
  ...
  window.addEventListener("message",async event=>{
    ...
    if(type==="elsus:ready"){
      ...
      acknowledge({capabilities:["save","open-app","theme","staff-control","latest-manifest","version-change","logout","navigate"]});
      return;
    }
