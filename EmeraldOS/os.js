...
/* =========================================================
   EMERALDOS NOTIFICATIONS SYSTEM
...
function initNotifications() {
    ...
    // Toast container (bottom-left popups)
    ...
    // Optional: ensure center exists
    const center = document.getElementById("notification-center");
    if (center) center.classList.remove("show");
}

/* =========================================================
   MASTER NOTIFY FUNCTION (USE THIS EVERYWHERE)
========================================================= */

function notify(title, message, duration = 3000, type = "default") {

    // 1. Save to center history
    notifications.push({
        title,
        message,
        time: Date.now(),
    ...
    // 2. Show toast popup
    showToast(title, message, duration, type);
}

/* =========================================================
   TOAST POPUP SYSTEM (BOTTOM LEFT)
========================================================= */

function showToast(title, message, duration, type) {
...
/* =========================================================
   CENTER NOTIFICATION RENDERER (HISTORY PANEL)
========================================================= */
