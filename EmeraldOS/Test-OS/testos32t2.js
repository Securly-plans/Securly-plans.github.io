...
(function () {
    ...
    if (window.TestOS32T1Loaded) {
        console.warn("TestOS 3.2.T.2 already loaded.");
        return;
    }
    ...
    const TESTOS_BUILD = {
        product: "TestOS",
        base: "EmeraldOS 3.2",
        displayName: "TestOS 3.2.T.2",
        version: "3.2.T.2",
        channel: "Test",
        codename: "Developer Edition Preview",
        experimental: true
    };
    ...
    function getTestOSEdition() {
        return normalizeEdition(localStorage.getItem("testos_edition") || "home");
    }
