...
/* =========================================================
   TESTOS 3.2.T.2 DEVELOPER EDITION PATCH
        ...
        window.openWindow("Build Inspector", `
            <div style="padding:10px;">
                ...
                <div class="inset-panel">
                    <b>Build:</b> ${safeHTML(build.displayName || "TestOS 3.2.T.2")}<br>
                    <b>Version:</b> ${safeHTML(build.version || "3.2.T.2")}<br>
