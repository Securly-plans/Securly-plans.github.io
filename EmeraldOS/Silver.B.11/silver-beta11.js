...
(function () {
    ...
    const BUILD = {
        ...
        displayName: "EmeraldOS Silver Beta 1.1",
        channel: "Beta",
        version: "1.1",
        codename: "Silver Continuity Workspace",
        platform: "EmeraldOS Platform 5.7",
        storagePrefix: "silver11_",
    ...
    function applyShellLabels() {
        ...
        if (buildBadge) buildBadge.textContent = "Beta 1.1";
    }
    ...
    function boot() {
        ...
        silverNotify("Silver Beta", "Welcome to EmeraldOS Silver Beta 1.1.", "System", "info");
    }
...
/* =========================================================
   EMERALDOS SILVER BETA 1.1 PATCH
...
(function () {
    ...
    const BUILD = {
        name: "EmeraldOS Silver Beta 1.1",
        storagePrefix: "silver11_",
        cloudCollection: "emeraldOSUsers",
    ...
    function applyDesktopPrefs() {
        ...
        if (badge) badge.textContent = "Silver Beta 1.1";
    ...
    function defaultDrive() {
        return [
            ...
            { id:"slide_plan", type:"eslide", title:"Project Presentation", updatedAt:new Date().toISOString(), slides:[{title:"Silver Beta 1.1",body:"Custom desktop, responsive UI, and Drive-like Office."}] }
        ];
    }
    ...
    window.openSilverUpdates11 = function () { openWindowSilver("Silver Updates", `<div class="silver-beta-shell"><div class="silver-beta-header">${iconHTML("sync")}<div><h2>Silver Updates</h2><p>Current build: EmeraldOS Silver Beta 1.1</p></div></div><ul><li>Customizable desktop folders.</li><li>Responsive Silver shell.</li><li>Drive-like Silver Office workspace.</li><li>More Silver applications.</li><li>Improved UI polish.</li></ul></div>`, "updates-11"); };
    ...
    function boot() {
        ...
        notify("Silver Beta 1.1", "Custom desktop folders and Silver Drive are ready.", "System", "success");
    }
