...
(function () {
    ...
    if (window.TestOS32T1Loaded) {
        console.warn("TestOS 3.2.T.4 already loaded.");
        return;
    }
    ...
    const TESTOS_BUILD = {
        product: "TestOS",
        base: "EmeraldOS 3.2",
        displayName: "TestOS 3.2.T.4",
        version: "3.2.T.4",
        channel: "Test",
        codename: "Economy + App Folders Preview",
        experimental: true
    };
    ...
    function ensureTestOSBootConfig() {
        if (!localStorage.getItem("testos_build_name")) {
            localStorage.setItem("testos_build_id", "testos32t4");
