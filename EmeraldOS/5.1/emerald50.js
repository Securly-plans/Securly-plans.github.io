...
(function () {
    ...
    const BUILD_50 = {
        product: "EmeraldOS",
        displayName: "EmeraldOS 5.0 Patch 1",
        version: "5.0.1",
        channel: "Stable",
    ...
    function setBuild50() {
        ...
        if (buildBadge) buildBadge.innerHTML = `<span class="emerald50-build-badge">EmeraldOS 5.0 Patch 1</span>`;
    }
    ...
    function clearDesktopSelection50() {
        ...
        /* Patch 1: do not blur active text fields/editors.
           The original 5.0 behavior broke typing by removing focus after clicks. */
    }
