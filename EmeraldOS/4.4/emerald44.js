...
(function () {
    ...
    if (window.EmeraldOS40Loaded) {
        console.warn("EmeraldOS 4.4 already loaded.");
        return;
    }
    ...
    const EMERALDOS_BUILD = {
        product: "EmeraldOS",
        base: "EmeraldOS 3.2",
        displayName: "EmeraldOS 4.4",
        version: "4.4",
        channel: "Stable",
        codename: "Staff Developer & Message Update",
        experimental: false
    };
...
(function () {
    ...
    window.openControllerCenter43 = function () {
        app43("Controller Center", `
            ...
            <p>EmeraldOS 4.4 uses the browser Gamepad API where supported.</p>
            <div class="emerald43-grid">
    ...
    window.openUpdateCenter43 = () => app43("Update Center", `<h3>Update Center</h3><div class="emerald43-inset"><b>Current:</b> EmeraldOS 4.4<br><b>Channel:</b> Stable<br><b>Status:</b> Application and input update installed.</div>`, "updateCenter43");
    ...
    window.openRegistryTweaks43 = () => app43("Registry Tweaks", `<h3>Registry Tweaks</h3><p>Common HKEY adjustments for EmeraldOS 4.4.</p>${btn43("Set Desktop Grid On", "EmeraldOSRegistry?.set?.('HKEY_CURRENT_USER\\Software\\EmeraldOS\\Desktop\\GridSnap','true');notify('Registry','GridSnap set.',2000,'success')")}${btn43("Set Compact Taskbar", "EmeraldOSRegistry?.set?.('HKEY_CURRENT_USER\\Software\\EmeraldOS\\Taskbar\\Compact','true');notify('Registry','Compact taskbar set.',2000,'success')")}`, "registryTweaks43");
    ...
    function installTerminalCommands43() {
        ...
        const wrapped = async function (cmdLine = "") {
            ...
            else if (cmd === "build") { result = "EmeraldOS 4.4 Staff Developer & Message Update"; }
            if (result !== null) {
    ...
    function setRegistryDefaults43() {
        try {
            window.EmeraldOSRegistry?.set?.("HKEY_LOCAL_MACHINE\\System\\Build\\Version", "4.4");
    ...
    function init43() {
        ...
        window.notify?.("EmeraldOS 4.4", "System and input update loaded.", 3200, "success");
    }
...
(function () {
    ...
    const WYATT_MESSAGE_44 = `Hello, I'm Wyatt Monroe, Director of Operations here at Emerald Systems and I want to say a few things about EmeraldOS 4.4.
...
3. Use of EmeraldOS is a privilage, files, accounts, edition access and EmeraldOS access can be denied at any time.`;
    ...
    window.openCloudQuota44 = function () {
        app44("Cloud Storage Limits", `
            ...
            <div class="emerald44-inset">EmeraldOS Files is designed as a free user-specific cloud storage tool. EmeraldOS 4.4 displays the official Files notice from Emerald Systems on the desktop and in the Files Policy app.</div>
        `, "cloudQuota44");
    };

    window.openSystemBulletin44 = function () {
        app44("System Bulletin", `
            <h3>EmeraldOS 4.4 Bulletin</h3>
            <div class="emerald44-inset">EmeraldOS 4.4 adds staff-gated Developer mode, more account/service applications, and a desktop message from Emerald Systems leadership.</div>
        `, "systemBulletin44");
    };
