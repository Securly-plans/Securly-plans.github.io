                ...
                var t, n = {
                    ...
                    "zlib/inflate.js": function(e, t, n) {
                        ...
                        n.inflate = function(e, t) {
                            var n, r, o, a, i, s, l, c, d, u, f, h, m, b, p, g, w, v, y, k, _, x, S, C, E = 0, U = new D.Buf8(4), P = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            ...
                            e: for (; ; )
                                    ...
                                    if (n.last)
                                        ...
                                        case 1:
                                            ...
                                            if (W) {
                                                ...
                                                for (; A < 288; )
                                                    T.lens[A++] = 8;
                                                for (z(1, T.lens, 0, 288, M, 0, T.work, {
                                                    bits: 9
                                                }),
                                                A = 0; A < 32; )
                                                    T.lens[A++] = 5;
                                ...
                                case 27:
                                    if (n.wrap) {
                                        ...
                                        e.total_out += f,
                                        n.total += f,
                                        f && (e.adler = n.check = (n.flags ? I : B)(n.check, o, f, i - f)),
                                        f = l,
                            ...
                            e.total_out += f,
                            n.total += f,
                            n.wrap && f && (e.adler = n.check = (n.flags ? I : B)(n.check, o, f, e.next_out - f)),
                    ...
                    "zlib/inftrees.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t, n, r, o, a, i, s) {
                            for (var l, c, d, u, f, h, m, b, p, g = s.bits, w = 0, v = 0, y = 0, k = 0, _ = 0, x = 0, S = 0, C = 0, E = 0, U = 0, P = null, A = 0, T = new R.Buf16(16), D = new R.Buf16(16), B = null, I = 0, w = 0; w <= 15; w++)
                                T[w] = 0;
                            for (v = 0; v < r; v++)
                                T[t[n + v]]++;
                            for (_ = g,
                            ...
                            0 === k)
                                ...
                                for (; ; ) {
                                    ...
                                    if (_ < w && (U & u) !== d) {
                                        for (f += y,
                                        C = 1 << (x = w - (S = 0 === S ? _ : S)); x + S < k && !((C -= T[x + S]) <= 0); )
                                            x++,
                                            C <<= 1;
                                        if (E += 1 << x,
                                        1 === e && 852 < E || 2 === e && 592 < E)
