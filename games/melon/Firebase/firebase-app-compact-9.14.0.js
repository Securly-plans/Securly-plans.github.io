!function(e, t) {
    ...
    const r = function(t) {
        ...
        for (let a = 0; a < t.length; a++) {
            ...
            e < 128 ? r[n++] = e : (e < 2048 ? r[n++] = e >> 6 | 192 : (55296 == (64512 & e) && a + 1 < t.length && 56320 == (64512 & t.charCodeAt(a + 1)) ? (e = 65536 + ((1023 & e) << 10) + (1023 & t.charCodeAt(++a)),
            r[n++] = e >> 18 | 240,
      ...
      , n = {
        ...
        decodeString(e, t) {
            return this.HAS_NATIVE_SUPPORT && !t ? atob(e) : function(e) {
                ...
                for (; r < e.length; ) {
                    var a, i, s = e[r++];
                    s < 128 ? t[n++] = String.fromCharCode(s) : 191 < s && s < 224 ? (a = e[r++],
                    t[n++] = String.fromCharCode((31 & s) << 6 | 63 & a)) : 239 < s && s < 365 ? (i = ((7 & s) << 18 | (63 & e[r++]) << 12 | (63 & e[r++]) << 6 | 63 & e[r++]) - 65536,
                    t[n++] = String.fromCharCode(55296 + (i >> 10)),
                    t[n++] = String.fromCharCode(56320 + (1023 & i))) : (a = e[r++],
                    i = e[r++],
                    t[n++] = String.fromCharCode((15 & s) << 12 | (63 & a) << 6 | 63 & i))
                }
                return t.join("")
        ...
        decodeStringToByteArray(e, t) {
            ...
            for (let c = 0; c < e.length; ) {
                ...
                if (++c,
                null == a || null == i || null == s || null == o)
                    throw Error();
                n.push(a << 2 | i >> 4),
                64 !== s && (n.push(i << 4 & 240 | s >> 2),
      ...
      , a = function(e) {
        return e = e,
        t = r(e),
        n.encodeByteArray(t, !0).replace(/\./g, "");
        var t
    };
    function c(e, t) {
    ...
    class s {
        ...
        wrapCallback(r) {
            return (e, t) => {
                ...
                "function" == typeof r && (this.promise.catch( () => {}
                ),
    ...
    class l {
        ...
        create(e, ...t) {
            var n, r = t[0] || {}, a = `${this.service}/${e}`, i = this.errors[e], i = i ? (n = r,
            i.replace(d, (e, t) => {
                var r = n[t];
    ...
    function x(e) {
        ...
        R.set(i, t))),
        B(e, T = T || [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction]) ? new Proxy(e,j) : e);
        var i, t
    }
    function z(e) {
    ...
    function ae(e) {
        var t = e.name;
        if (te.has(t))
            return X.debug(`There were multiple attempts to register component ${t}.`),
            !1;
        te.set(t, e);
    ...
    function he(e, t={}) {
        ...
        if ("string" != typeof a || !a)
            throw se.create("bad-app-name", {
                appName: String(a)
            });
        if (r = r || h(),
        !r)
            throw se.create("no-options");
        var i = ee.get(a);
        if (i) {
            if (u(r, i.options) && u(n, i.config))
                return i;
    ...
    function de(e, t, r) {
        ...
        if (a || i) {
            ...
            return a && s.push(`library name "${n}" contains illegal characters (whitespace or "/")`),
            a && i && s.push("and"),
    ...
    function pe(e, t) {
        ...
        !function(i, e) {
            for (const t of I) {
                ...
                t.userLogHandler = null === i ? null : (e, t, ...r) => {
                    var n = r.map(e => {
                        if (null == e)
                            return null;
                        if ("string" == typeof e)
    ...
    class ye {
        ...
        async triggerHeartbeat() {
            ...
            this._heartbeatsCache.lastSentHeartbeatDate !== r && !this._heartbeatsCache.heartbeats.some(e => e.date === r))
        ...
        async getHeartbeatsHeader() {
            ...
            0 < r.length ? (this._heartbeatsCache.heartbeats = r,
    ...
    class we {
        ...
        async runIndexedDBEnvironmentCheck() {
            return "object" == typeof indexedDB && new Promise( (t, r) => {
                try {
                    let e = !0;
                    ...
                    a.onsuccess = () => {
                        a.result.close(),
                        e || self.indexedDB.deleteDatabase(n),
                        t(!0)
                    }
                    ,
                    a.onupgradeneeded = () => {
    ...
    class Se {
        ...
        _getService(e, t=Z) {
            ...
            return n.isInitialized() || "EXPLICIT" !== (null === (r = n.getComponent()) || void 0 === r ? void 0 : r.instantiationMode) || n.initialize(),
            n.getImmediate({
                identifier: t
            })
        }
                      ...
                      , t = n.replace("-compat", "");
                    {
                        ...
                        ae(r) && "PUBLIC" === r.type && (e = (e=o()) => {
                            if ("function" != typeof e[t])
                                throw Ae.create("invalid-app-argument", {
                                    appName: n
                                });
                            return e[t]()
                        }
  ...
  `);
    ...
    return Be.registerVersion("firebase", "9.14.0", "app-compat-cdn"),
    Be
});
